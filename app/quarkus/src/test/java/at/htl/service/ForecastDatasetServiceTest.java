...
class ForecastDatasetServiceTest {
    ...
    @Test
    void consumptionDatasetUsesConsumptionDirectionAndMetadata() throws Exception {
        ...
        ForecastDatasetResponse response = service.getDataset("consumption", "2025-06-01T00:00:00Z", "2025-06-02T00:00:00Z");

        assertEquals("PT15M", response.sampleInterval());
        assertEquals("consumption", response.targetColumn());
    ...
    void rejectsInvalidRequestParameters() throws Exception {
        ...
        assertThrows(IllegalArgumentException.class, () -> service.getDataset("consumption", "invalid", "2025-06-02T00:00:00Z"));
        assertThrows(IllegalArgumentException.class, () -> service.getDataset("consumption", "2025-06-02T00:00:00Z", "2025-06-01T00:00:00Z"));
    }
